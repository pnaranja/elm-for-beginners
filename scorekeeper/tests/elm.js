...
var _project_fuzzball$test$Test_Expectation$Fail = F2(
	function (a, b) {
		return {ctor: 'Fail', _0: a, _1: b};
	});
var _project_fuzzball$test$Test_Expectation$withGiven = F2(
	function (given, outcome) {
		var _p0 = outcome;
		if (_p0.ctor === 'Fail') {
			return A2(_project_fuzzball$test$Test_Expectation$Fail, given, _p0._1);
		} else {
			return outcome;
		}
	});
var _project_fuzzball$test$Test_Expectation$Pass = {ctor: 'Pass'};
...
var _project_fuzzball$test$Fuzz_Internal$Fuzzer = function (a) {
...
var _project_fuzzball$test$Fuzz$okOrCrash = function (result) {
	...
	if (_p2.ctor === 'Ok') {
		...
		return _elm_lang$core$Native_Utils.crashCase(
			'Fuzz',
			{
				start: {line: 366, column: 5},
				end: {line: 371, column: 28}
			},
			_p2)(_p2._0);
	}
};
var _project_fuzzball$test$Fuzz$charGenerator = A2(
	_mgold$elm_random_pcg$Random_Pcg$map,
	_elm_lang$core$Char$fromCode,
	A2(_mgold$elm_random_pcg$Random_Pcg$int, 32, 126));
var _project_fuzzball$test$Fuzz$custom = F2(
	function (generator, shrinker) {
		return _project_fuzzball$test$Fuzz_Internal$Fuzzer(
			{generator: generator, shrinker: shrinker});
	});
var _project_fuzzball$test$Fuzz$unit = A2(
	_project_fuzzball$test$Fuzz$custom,
	_mgold$elm_random_pcg$Random_Pcg$constant(
		{ctor: '_Tuple0'}),
	_elm_community$shrink$Shrink$noShrink);
var _project_fuzzball$test$Fuzz$bool = A2(_project_fuzzball$test$Fuzz$custom, _mgold$elm_random_pcg$Random_Pcg$bool, _elm_community$shrink$Shrink$bool);
...
var _project_fuzzball$test$Fuzz$int = function () {
	...
	return A2(_project_fuzzball$test$Fuzz$custom, generator, _elm_community$shrink$Shrink$int);
}();
...
var _project_fuzzball$test$Fuzz$float = function () {
	...
	return A2(_project_fuzzball$test$Fuzz$custom, generator, _elm_community$shrink$Shrink$float);
}();
...
var _project_fuzzball$test$Fuzz$char = A2(_project_fuzzball$test$Fuzz$custom, _project_fuzzball$test$Fuzz$charGenerator, _elm_community$shrink$Shrink$character);
var _project_fuzzball$test$Fuzz$string = A2(
	_project_fuzzball$test$Fuzz$custom,
	A3(_project_fuzzball$test$Util$rangeLengthString, 0, 10, _project_fuzzball$test$Fuzz$charGenerator),
	_elm_community$shrink$Shrink$string);
var _project_fuzzball$test$Fuzz$maybe = function (_p4) {
	var _p5 = _p4;
	var genBool = A2(
		_mgold$elm_random_pcg$Random_Pcg$map,
...
var _project_fuzzball$test$Fuzz$list = function (_p12) {
	var _p13 = _p12;
		...
		_mgold$elm_random_pcg$Random_Pcg$frequency(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					ctor: '_Tuple2',
					_0: 3,
					_1: A3(_project_fuzzball$test$Util$rangeLengthList, 2, 10, _p14)
				},
					{
					ctor: '_Tuple2',
					_0: 2,
					_1: A3(_project_fuzzball$test$Util$rangeLengthList, 10, 100, _p14)
				},
					{
					ctor: '_Tuple2',
					_0: 0.5,
					_1: A3(_project_fuzzball$test$Util$rangeLengthList, 100, 400, _p14)
				}
				])),
		_elm_community$shrink$Shrink$list(_p13._0.shrinker));
};
var _project_fuzzball$test$Fuzz$array = function (_p15) {
	var _p16 = _p15;
		...
		_mgold$elm_random_pcg$Random_Pcg$frequency(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					ctor: '_Tuple2',
					_0: 3,
					_1: A3(_project_fuzzball$test$Util$rangeLengthArray, 2, 10, _p17)
				},
					{
					ctor: '_Tuple2',
					_0: 2,
					_1: A3(_project_fuzzball$test$Util$rangeLengthArray, 10, 100, _p17)
				},
					{
					ctor: '_Tuple2',
					_0: 0.5,
					_1: A3(_project_fuzzball$test$Util$rangeLengthArray, 100, 400, _p17)
				}
				])),
		_elm_community$shrink$Shrink$array(_p16._0.shrinker));
};
var _project_fuzzball$test$Fuzz$tuple = function (_p18) {
	var _p19 = _p18;
	var _p21 = _p19._1._0;
	var _p20 = _p19._0._0;
	return A2(
...
var _project_fuzzball$test$Fuzz$tuple3 = function (_p22) {
	var _p23 = _p22;
	var _p26 = _p23._2._0;
	var _p25 = _p23._1._0;
	var _p24 = _p23._0._0;
...
var _project_fuzzball$test$Fuzz$tuple4 = function (_p27) {
	var _p28 = _p27;
	var _p32 = _p28._3._0;
	var _p31 = _p28._2._0;
	var _p30 = _p28._1._0;
...
var _project_fuzzball$test$Fuzz$tuple5 = function (_p33) {
	var _p34 = _p33;
	var _p39 = _p34._4._0;
	var _p38 = _p34._3._0;
	var _p37 = _p34._2._0;
	...
	if (_p42.ctor === 'Nothing') {
		...
		if (A2(
			...
			if (_elm_lang$core$Native_Utils.cmp(
				...
				return _elm_lang$core$Result$Ok(
					A2(_project_fuzzball$test$Fuzz$custom, generator, _p42._0._1._0.shrinker));
			}
		}
	}
};
var _project_fuzzball$test$Fuzz$frequencyOrCrash = function (_p45) {
	return _project_fuzzball$test$Fuzz$okOrCrash(
		_project_fuzzball$test$Fuzz$frequency(_p45));
};

var _project_fuzzball$test$Test_Internal$isFail = F2(
	function (x, y) {
		return !_elm_lang$core$Native_Utils.eq(x, y);
	})(_project_fuzzball$test$Test_Expectation$Pass);
var _project_fuzzball$test$Test_Internal$formatExpectation = function (_p0) {
	var _p1 = _p0;
	return A2(_project_fuzzball$test$Test_Expectation$withGiven, _p1._0, _p1._1);
};
var _project_fuzzball$test$Test_Internal$shrinkAndAdd = F4(
	function (shrinker, getExpectation, val, dict) {
		var result = A3(
			_elm_community$shrink$Shrink$shrink,
			function (_p2) {
				return _project_fuzzball$test$Test_Internal$isFail(
					getExpectation(_p2));
			},
			shrinker,
			val);
...
var _project_fuzzball$test$Test_Internal$Batch = function (a) {
	return {ctor: 'Batch', _0: a};
};
var _project_fuzzball$test$Test_Internal$Labeled = F2(
	function (a, b) {
		return {ctor: 'Labeled', _0: a, _1: b};
	});
var _project_fuzzball$test$Test_Internal$filterHelp = F3(
	function (lastCheckPassed, isKeepable, test) {
		var _p3 = test;
		switch (_p3.ctor) {
			case 'Test':
				return lastCheckPassed ? test : _project_fuzzball$test$Test_Internal$Batch(
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'Labeled':
				var _p4 = _p3._0;
				return A2(
					_project_fuzzball$test$Test_Internal$Labeled,
					_p4,
					A3(
						_project_fuzzball$test$Test_Internal$filterHelp,
						isKeepable(_p4),
						isKeepable,
						_p3._1));
			default:
				return _project_fuzzball$test$Test_Internal$Batch(
					A2(
						_elm_lang$core$List$map,
						A2(_project_fuzzball$test$Test_Internal$filterHelp, lastCheckPassed, isKeepable),
						_p3._0));
		}
	});
var _project_fuzzball$test$Test_Internal$filter = _project_fuzzball$test$Test_Internal$filterHelp(false);
var _project_fuzzball$test$Test_Internal$Test = function (a) {
	return {ctor: 'Test', _0: a};
};
var _project_fuzzball$test$Test_Internal$fuzzTest = F3(
			...
			function (seed, runs) {
				var getFailures = F3(
					function (failures, currentSeed, remainingRuns) {
						getFailures:
						while (true) {
							var _p7 = A2(_mgold$elm_random_pcg$Random_Pcg$step, _p6._0.generator, seed);
							var val = _p7._0;
							var nextSeed = _p7._1;
							var newFailures = _elm_lang$core$Native_Utils.eq(
								getExpectation(val),
								_project_fuzzball$test$Test_Expectation$Pass) ? failures : A4(_project_fuzzball$test$Test_Internal$shrinkAndAdd, _p6._0.shrinker, getExpectation, val, failures);
				...
				return _elm_lang$core$Dict$isEmpty(failures) ? _elm_lang$core$Native_List.fromArray(
					[_project_fuzzball$test$Test_Expectation$Pass]) : A2(
					_elm_lang$core$List$map,
					_project_fuzzball$test$Test_Internal$formatExpectation,
					_elm_lang$core$Dict$toList(failures));
			});
		return A2(
			_project_fuzzball$test$Test_Internal$Labeled,
			desc,
			_project_fuzzball$test$Test_Internal$Test(run));
	});
...
var _project_fuzzball$test$Expect$onFail = F2(
	function (str, expectation) {
		...
		if (_p0.ctor === 'Pass') {
			...
			return A2(_project_fuzzball$test$Test_Expectation$Fail, _p0._0, str);
		}
	});
...
var _project_fuzzball$test$Test$fuzz = _project_fuzzball$test$Test_Internal$fuzzTest;
	...
	function (fuzzA, fuzzB, fuzzC, desc) {
		...
		return function (_p7) {
			return A3(
				...
				fuzzer,
				desc,
				_project_fuzzball$test$Test$uncurry3(_p7));
		};
	});
	...
	function (fuzzA, fuzzB, fuzzC, fuzzD, desc) {
		...
		return function (_p8) {
			return A3(
				...
				fuzzer,
				desc,
				_project_fuzzball$test$Test$uncurry4(_p8));
		};
	});
	...
	function (fuzzA, fuzzB, fuzzC, fuzzD, fuzzE, desc) {
		...
		return function (_p9) {
			return A3(
				...
				fuzzer,
				desc,
				_project_fuzzball$test$Test$uncurry5(_p9));
		};
	});
var _project_fuzzball$test$Test$fuzzWithHelp = F2(
	function (options, test) {
		...
		switch (_p10.ctor) {
			case 'Test':
				return _project_fuzzball$test$Test_Internal$Test(
					F2(
						function (seed, _p11) {
...
var _project_fuzzball$test$Test$test = F2(
	function (desc, thunk) {
		return A2(
			_project_fuzzball$test$Test_Internal$Labeled,
			desc,
			_project_fuzzball$test$Test_Internal$Test(
				F2(
					function (_p13, _p12) {
						return _elm_lang$core$Native_List.fromArray(
							[
...
var _project_fuzzball$test$Test$fuzzWith = F4(
	function (options, fuzzer, desc, getTest) {
		return (_elm_lang$core$Native_Utils.cmp(options.runs, 1) < 0) ? A2(
			...
			options,
			A3(_project_fuzzball$test$Test$fuzz, fuzzer, desc, getTest));
	});
var _project_fuzzball$test$Test$describe = function (desc) {
	return function (_p16) {
		return A2(
			_project_fuzzball$test$Test_Internal$Labeled,
			desc,
			_project_fuzzball$test$Test_Internal$Batch(_p16));
	};
};
var _project_fuzzball$test$Test$filter = _project_fuzzball$test$Test_Internal$filter;
var _project_fuzzball$test$Test$concat = _project_fuzzball$test$Test_Internal$Batch;
var _project_fuzzball$test$Test$FuzzOptions = function (a) {
	return {runs: a};
};

var _user$project$ScoreKeeper$playHeader = function (model) {
	return A2(
...
var _user$project$ScoreKeeper$pointTotal = function (model) {
	var totalpts = _elm_lang$core$List$sum(
		A2(
			_elm_lang$core$List$map,
			function (player) {
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Basics$toString(totalpts))
					]))
			]));
};
var _user$project$ScoreKeeper$playerListHeader = A2(
	_elm_lang$html$Html$header,
	_elm_lang$core$Native_List.fromArray(
		[]),
	_elm_lang$core$Native_List.fromArray(
...
var _user$project$ScoreKeeper$deletePlayModel = F2(
	function (model, play) {
		var newPlayers = A2(
			_elm_lang$core$List$map,
			function (player) {
				return _elm_lang$core$Native_Utils.eq(player.name, play.name) ? _elm_lang$core$Native_Utils.update(
					player,
					{totalpoints: player.totalpoints - play.points}) : player;
			},
			model.players);
		var newplays = A2(
...
var _user$project$ScoreKeeper$changePlayerPtsIfMatch = F3(
	function (player1, player2, pts) {
		return _elm_lang$core$Native_Utils.eq(player1.name, player2.name) ? _elm_lang$core$Native_Utils.update(
			player1,
			{totalpoints: player1.totalpoints + pts}) : player1;
	});
var _user$project$ScoreKeeper$changePlayName = F3(
	function (player, newname, play) {
		return _elm_lang$core$Native_Utils.eq(play.name, player.name) ? _elm_lang$core$Native_Utils.update(
			play,
			{name: newname}) : play;
	});
var _user$project$ScoreKeeper$Model = F4(
	function (a, b, c, d) {
		return {players: a, name: b, mode: c, plays: d};
	});
var _user$project$ScoreKeeper$Player = F4(
	function (a, b, c, d) {
		return {id: a, name: b, totalpoints: c, select: d};
	});
var _user$project$ScoreKeeper$Play = F4(
	function (a, b, c, d) {
		return {id: a, playerId: b, name: c, points: d};
	});
var _user$project$ScoreKeeper$changePtsModel = F3(
	function (model, player, pts) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				players: A2(
					_elm_lang$core$List$map,
					function (plyer) {
						return A3(_user$project$ScoreKeeper$changePlayerPtsIfMatch, plyer, player, pts);
					},
					model.players),
				plays: A2(
					_elm_lang$core$List_ops['::'],
					A4(
						_user$project$ScoreKeeper$Play,
...
var _user$project$ScoreKeeper$AddPlayer = {ctor: 'AddPlayer'};
var _user$project$ScoreKeeper$initModel = {
	players: _elm_lang$core$Native_List.fromArray(
		[]),
	name: '',
	mode: _user$project$ScoreKeeper$AddPlayer,
	plays: _elm_lang$core$Native_List.fromArray(
		[])
};
var _user$project$ScoreKeeper$EditPlayer = function (a) {
	return {ctor: 'EditPlayer', _0: a};
};
var _user$project$ScoreKeeper$NotSelect = {ctor: 'NotSelect'};
var _user$project$ScoreKeeper$changePlayerNameSelect = F3(
	function (id, newname, player) {
		return _elm_lang$core$Native_Utils.eq(player.id, id) ? _elm_lang$core$Native_Utils.update(
			player,
			{name: newname, select: _user$project$ScoreKeeper$NotSelect}) : player;
	});
var _user$project$ScoreKeeper$changeNameModel = F2(
	function (player, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				players: A2(
					_elm_lang$core$List$map,
					A2(_user$project$ScoreKeeper$changePlayerNameSelect, player.id, model.name),
					model.players),
				plays: A2(
					_elm_lang$core$List$map,
					A2(_user$project$ScoreKeeper$changePlayName, player, model.name),
					model.plays),
				name: '',
				mode: _user$project$ScoreKeeper$AddPlayer
			});
	});
var _user$project$ScoreKeeper$saveModel = function (model) {
	var _p0 = model.mode;
	if (_p0.ctor === 'AddPlayer') {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				players: A2(
					_elm_lang$core$List_ops['::'],
					A4(
						_user$project$ScoreKeeper$Player,
						_elm_lang$core$List$length(model.players),
						model.name,
						0,
						_user$project$ScoreKeeper$NotSelect),
					model.players),
				name: ''
			});
	} else {
		return A2(_user$project$ScoreKeeper$changeNameModel, _p0._0, model);
	}
};
var _user$project$ScoreKeeper$Select = {ctor: 'Select'};
var _user$project$ScoreKeeper$editModeModelHighlight = F2(
	function (player, model) {
		var newPlayers = A2(
			_elm_lang$core$List$map,
			function (p) {
				return _elm_lang$core$Native_Utils.eq(p.name, player.name) ? _elm_lang$core$Native_Utils.update(
					p,
					{select: _user$project$ScoreKeeper$Select}) : p;
			},
			model.players);
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				name: player.name,
				mode: _user$project$ScoreKeeper$EditPlayer(player),
				players: newPlayers
			});
	});
var _user$project$ScoreKeeper$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'Input':
			...
			case 'Cancel':
				return _elm_lang$core$Native_Utils.update(
					model,
					{name: '', mode: _user$project$ScoreKeeper$AddPlayer});
			case 'Save':
				return _elm_lang$core$String$isEmpty(model.name) ? model : _user$project$ScoreKeeper$saveModel(model);
			case 'Edit':
				return A2(_user$project$ScoreKeeper$editModeModelHighlight, _p1._0, model);
			case 'Score':
				return A3(_user$project$ScoreKeeper$changePtsModel, model, _p1._0, _p1._1);
			default:
				return A2(_user$project$ScoreKeeper$deletePlayModel, model, _p1._0);
		}
	});
var _user$project$ScoreKeeper$editSelect = function (player) {
	return _elm_lang$core$Native_Utils.eq(player.select, _user$project$ScoreKeeper$Select) ? _elm_lang$html$Html_Attributes$style(
		_elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple2', _0: 'backgroundColor', _1: 'LightSkyBlue'}
			])) : _elm_lang$html$Html_Attributes$style(
		_elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple2', _0: 'backgroundColor', _1: 'White'}
			]));
};
var _user$project$ScoreKeeper$Delete = function (a) {
	return {ctor: 'Delete', _0: a};
};
var _user$project$ScoreKeeper$playListRow = function (play) {
	return A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_user$project$ScoreKeeper$Delete(play))
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
...
var _user$project$ScoreKeeper$playSection = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$ScoreKeeper$playHeader(model),
				A2(
				_elm_lang$html$Html$ul,
				_elm_lang$core$Native_List.fromArray(
					[]),
				A2(_elm_lang$core$List$map, _user$project$ScoreKeeper$playListRow, model.plays))
			]));
};
var _user$project$ScoreKeeper$Cancel = {ctor: 'Cancel'};
var _user$project$ScoreKeeper$Save = {ctor: 'Save'};
var _user$project$ScoreKeeper$Input = function (a) {
	return {ctor: 'Input', _0: a};
};
var _user$project$ScoreKeeper$playerForm = function (model) {
	return A2(
		_elm_lang$html$Html$form,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Events$onSubmit(_user$project$ScoreKeeper$Save)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Events$onInput(_user$project$ScoreKeeper$Input),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Events$onClick(_user$project$ScoreKeeper$Cancel)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
...
var _user$project$ScoreKeeper$Score = F2(
	function (a, b) {
		return {ctor: 'Score', _0: a, _1: b};
	});
var _user$project$ScoreKeeper$Edit = function (a) {
	return {ctor: 'Edit', _0: a};
};
var _user$project$ScoreKeeper$playerListRow = function (player) {
	return A2(
		_elm_lang$html$Html$li,
		_elm_lang$core$Native_List.fromArray(
			[]),
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Events$onClick(
						_user$project$ScoreKeeper$Edit(player))
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$ScoreKeeper$editSelect(player)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$type$('button'),
						_elm_lang$html$Html_Events$onClick(
						A2(_user$project$ScoreKeeper$Score, player, 2))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$type$('button'),
						_elm_lang$html$Html_Events$onClick(
						A2(_user$project$ScoreKeeper$Score, player, 3))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						_elm_lang$core$Basics$toString(player.totalpoints))
					]))
			]));
};
var _user$project$ScoreKeeper$playerList = function (model) {
	return A2(
		_elm_lang$html$Html$ul,
		_elm_lang$core$Native_List.fromArray(
			[]),
		A2(
			_elm_lang$core$List$map,
			_user$project$ScoreKeeper$playerListRow,
			A2(
...
var _user$project$ScoreKeeper$playerSection = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$ScoreKeeper$playerListHeader,
				_user$project$ScoreKeeper$playerList(model),
				_user$project$ScoreKeeper$pointTotal(model)
			]));
};
var _user$project$ScoreKeeper$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('ScoreKeeper')
					])),
				_user$project$ScoreKeeper$playerSection(model),
				_user$project$ScoreKeeper$playerForm(model),
				_user$project$ScoreKeeper$playSection(model)
			]));
};
var _user$project$ScoreKeeper$main = {
	main: _elm_lang$html$Html_App$beginnerProgram(
		{model: _user$project$ScoreKeeper$initModel, update: _user$project$ScoreKeeper$update, view: _user$project$ScoreKeeper$view})
};

var _user$project$Tests$initModelTest = A2(
	_project_fuzzball$test$Expect$equal,
	_user$project$ScoreKeeper$initModel,
	{
		players: _elm_lang$core$Native_List.fromArray(
			[]),
		name: '',
...
var _user$project$Tests$all = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			function (_p0) {
				var _p1 = _p0;
				return _user$project$Tests$initModelTest;
			}),
			A2(
			_project_fuzzball$test$Test$test,
			'String.left',
...
var Elm = {};
Elm['Tests'] = Elm['Tests'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Tests'], 'Tests', typeof _user$project$Tests$main === 'undefined' ? null : _user$project$Tests$main);
